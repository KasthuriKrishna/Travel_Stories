...
const Summer1 = () => {
  ...
  return (
    <>
    <div><img width={1370} height={500} src='https://media.easemytrip.com/media/Blog/International/637867579316652136/637867579316652136pUfqUI.jpg'></img></div>
    <div>
    <h2>HIDDEN SPOTS---></h2>
